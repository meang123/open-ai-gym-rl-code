...
def main():
    ...
    parser.add_argument("--start_timesteps", default=25e1, type=int)  # Time steps initial random policy is used 25e3 25e1
    parser.add_argument("--eval_freq", default=5e2, type=int)  # How often (time steps) we evaluate 5e2
        ...
        for t in range(int(args.max_timesteps)):
            ...
            while True:
                ...
                if policy.has_enough_experience(buffer) and t > args.start_timesteps:
                    ...
                    c1,c2,actor_loss,alpha,alpha_loss = policy.train(BETA,ALPHA,buffer)
                ...
                if (t + 1) % args.eval_freq == 0:
                    ...
                    if args.write:
                        ...
                        args.summary_writer.add_scalar('PER_alpha', ALPHA, global_step=t)
