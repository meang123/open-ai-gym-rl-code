...
class TensorboardCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if self.locals['dones'][0]:
            self.logger.record("custom/reward", self.locals['infos'][0]['reward'])
            ...
            self.logger.record("custom/center_lane_deviation", self.locals['infos'][0]['center_lane_deviation'])
            self.logger.record("custom/distance_covered", self.locals['infos'][0]['distance_covered'])
